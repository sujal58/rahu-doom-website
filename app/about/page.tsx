...
const founders = [
  { name: "Kamal Neupane", role: "Co-Founder", note: "Spent several years in the USA, now bringing that experience and expertise home to Nepal", image: "/Kamal_Neupane.png", flag: "us", flagLabel: "USA", linkedin: "#" },
  { name: "Sunil Sharma", role: "Co-Founder", note: "Founder of ZilFox Digital Solutions · IT & Marketing", image: "/Sunil_Sharma.png", flag: "in", flagLabel: "India", linkedin: "#" },
  { name: "Rohan Pandey", role: "Co-Founder", note: "Founder of Prashant Digital Growth · IT & Marketing", image: "/Rohan_Pandey.png", flag: "np", flagLabel: "Nepal", linkedin: "#" },
];

const values = [
  { icon: Target, title: "Our Mission", text: "To help businesses in Nepal and beyond grow through reliable, well-built technology — without the agency runaround." },
  { icon: Eye, title: "Our Vision", text: "To be Nepal's most trusted software partner, known for quality work and genuine, long-term relationships." },
  { icon: Heart, title: "Our Values", text: "Honesty, craftsmanship, and real ownership of the outcomes we deliver for every client." },
];

const journey = [
  { year: "2024", title: "Where it began", text: "Kamal, Sunil, and Rohan first connected over LinkedIn, discovering a shared vision to build something meaningful back home." },
  { year: "2025", title: "Planning the foundation", text: "Months of conversations turned an idea into a plan — the team, the mission, and the roadmap for Rahu Doom took shape." },
  { year: "2026", title: "Officially launched", text: "In May 2026, Rahu Doom Pvt Ltd officially opened its doors in Nepal, ready to spark a digital revolution." },
];
    ...
    <>
      <section className="relative overflow-hidden border-b border-white/10 bg-[#0F1115]">
        ...
        <div className="relative mx-auto max-w-container px-5 py-20 lg:px-8 lg:py-28">
          <Reveal>
            <p className="text-sm font-semibold uppercase tracking-wider text-brand">About {company.shortName}</p>
      ...
      <section className="border-b border-white/10 bg-[#15181D]">
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.4fr]">
          <Reveal>
            <p className="text-sm font-semibold uppercase tracking-wider text-brand">Our story</p>
          ...
          <Reveal delay={120}>
            <div className="space-y-5 text-lg text-white/60">
              <p>
                The company was founded by three professionals who each carved
                their own path before coming together. Kamal Neupane spent
                several years in the United States running an IT company, and
                returned home eager to put that experience and expertise to work
                in Nepal. Sunil Sharma, after working across multiple companies in
                India, went on to successfully launch his own venture —{" "}
                <a
                ...
                Rohan Pandey made his name running his own agency, Prashant
                Digital Growth, building sharp expertise across both IT and
                digital marketing.
              </p>
              <p>
                Three different journeys, one common dream: to return home and
                build something meaningful for their own country. Together, they
                founded Rahu Doom Pvt Ltd in Nepal — driven by a single mission:
                to spark a digital revolution at home and help Nepali businesses
        ...
        <div className="mx-auto max-w-container px-5 py-20 lg:px-8 lg:py-24">
          <Reveal>
            <div className="max-w-2xl">
              <p className="text-sm font-semibold uppercase tracking-wider text-brand">Our journey</p>
          ...
          <Reveal>
            <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
              ...
              <p className="max-w-xs text-sm text-white/50">
                Three paths, one shared mission — to build world-class technology right here in Nepal.
              </p>
            </div>
          </Reveal>
            ...
            {founders.map((m, i) => {
              ...
              return (
                <Reveal key={m.name} delay={i * 100}>
                  <article className="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-white/[0.08] bg-white/[0.04] transition-all duration-300 hover:-translate-y-2 hover:border-brand/40 hover:shadow-[0_28px_60px_-22px_rgba(164,22,26,0.55)]">
                    ...
                    <div className="relative aspect-[4/5] overflow-hidden">
                      ...
                      <div aria-hidden className="absolute inset-0 bg-gradient-to-t from-[#0e0e0e] via-transparent to-transparent" />
                      ...
                      <span className="absolute right-3 top-3 flex items-center gap-1.5 rounded-full border border-white/15 bg-black/50 py-1 pl-1.5 pr-2.5 backdrop-blur-sm">
                        ...
                        />
                        <span className="text-[10px] font-bold uppercase tracking-wider text-white/90">{m.flagLabel}</span>
                      </span>
                    </div>
                    ...
                    <div className="flex flex-1 flex-col p-6">
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          <h3 className="text-lg font-extrabold leading-tight text-white">{m.name}</h3>
                      ...
                      <p className="mt-4 text-sm leading-relaxed text-white/55">{m.note}</p>
                    </div>
      ...
      <section className="bg-brand">
        <div className="mx-auto flex max-w-container flex-col items-center justify-between gap-6 px-5 py-14 text-center sm:flex-row sm:text-left lg:px-8">
          <h2 className="text-3xl font-extrabold text-white">Want to work with us?</h2>
          <Link
            href="/contact"
