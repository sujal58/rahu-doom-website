      ...
      <article className="group cursor-pointer transition-transform duration-300 hover:-translate-y-1">
        ...
        <div className="relative overflow-hidden rounded-2xl">
          ...
          <div className="absolute right-3 top-3 min-w-[48px] rounded-xl bg-white px-3 py-2 text-center shadow-md">
            ...
            <p className="mt-0.5 text-[10px] font-bold uppercase tracking-wide text-ink-mute">
              {post.month}
            </p>
          </div>
        </div>
        ...
        <div className="relative z-10 -mt-7 mx-1 rounded-2xl border-b-[3px] border-transparent bg-[#15181D] p-5 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.5)] transition-colors duration-300 group-hover:border-brand">
          {/* Meta row */}
